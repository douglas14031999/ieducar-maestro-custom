import{h as s,u as n}from"./common.1ymnu820c3.js";import{d as c,u as i,r as u,o as d,c as l,a as m}from"./vendor.1ymnu820c3.js";const g=()=>s.get("/auth/login",{withCredentials:!0}).then(e=>e.data),h=["innerHTML"],_=c({__name:"Login",setup(e){const a=i(),o=u("Logando.."),{loader:t}=n();return t(g).then(r=>{if(!r)throw new Error;a.push({name:"preregistrations"})}).catch(()=>{o.value=`
